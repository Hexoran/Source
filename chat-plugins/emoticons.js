...
Equ.ignoreEmotes = {};
try {
	Equ.ignoreEmotes = JSON.parse(fs.readFileSync(DATA_DIR + 'ignoreemotes.json', 'utf8'));
} catch (e) {}
exports.ignoreEmotes = Equ.ignoreEmotes;
Equ.ignoreEmotes = Equ.ignoreEmotes;
...
Equ.parseEmoticons = parseEmoticons;
